...
def test_predict():
    ...
    assert actual_prediction == expected_prediction, f"Expected {expected_prediction}, got {actual_prediction}"
...
def test_lambda_handler():
    ...
    assert actual_predictions == expected_predictions, f"Expected {expected_predictions}, got {actual_predictions}"